...
func (s *DockerSuite) TestRunNoDupVolumes(c *check.C) {
	...
	// Test for https://github.com/ellcrys/docker/issues/22093
	volumename1 := "test1"
	volumename2 := "test2"
...
// https://github.com/ellcrys/docker/issues/12148
...
// Regression test for https://github.com/ellcrys/docker/issues/8259
...
func (s *DockerSuite) TestRunWithTooSmallMemoryLimit(c *check.C) {
	...
	// https://github.com/ellcrys/docker/blob/v1.5.0/daemon/create.go#L22
...
// https://github.com/ellcrys/docker/pull/14498
