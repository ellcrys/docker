...
import (
	...
	apiserver "github.com/ellcrys/docker/api/server"
	buildbackend "github.com/ellcrys/docker/api/server/backend/build"
	"github.com/ellcrys/docker/api/server/middleware"
	"github.com/ellcrys/docker/api/server/router"
	"github.com/ellcrys/docker/api/server/router/build"
	checkpointrouter "github.com/ellcrys/docker/api/server/router/checkpoint"
	"github.com/ellcrys/docker/api/server/router/container"
	distributionrouter "github.com/ellcrys/docker/api/server/router/distribution"
	"github.com/ellcrys/docker/api/server/router/image"
	"github.com/ellcrys/docker/api/server/router/network"
	pluginrouter "github.com/ellcrys/docker/api/server/router/plugin"
	sessionrouter "github.com/ellcrys/docker/api/server/router/session"
	swarmrouter "github.com/ellcrys/docker/api/server/router/swarm"
	systemrouter "github.com/ellcrys/docker/api/server/router/system"
	"github.com/ellcrys/docker/api/server/router/volume"
	"github.com/ellcrys/docker/builder/dockerfile"
	"github.com/ellcrys/docker/builder/fscache"
	"github.com/ellcrys/docker/cli/debug"
	"github.com/ellcrys/docker/daemon"
	"github.com/ellcrys/docker/daemon/cluster"
	"github.com/ellcrys/docker/daemon/config"
	"github.com/ellcrys/docker/daemon/listeners"
	"github.com/ellcrys/docker/dockerversion"
	"github.com/ellcrys/docker/libcontainerd"
	dopts "github.com/ellcrys/docker/opts"
	"github.com/ellcrys/docker/pkg/authorization"
	"github.com/ellcrys/docker/pkg/jsonmessage"
	"github.com/ellcrys/docker/pkg/pidfile"
