...
import (
	...
	"github.com/ellcrys/docker/distribution/xfer"
...
// warning: ref can be github.com/ellcrys/docker/vendor/github.com/docker/distribution/registry/client/auth.Scope (interfacer)
