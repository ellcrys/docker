...
repository](https://github.com/ellcrys/docker.github.io). Reviewers must
...
[`VERSION`](https://github.com/ellcrys/docker/blob/master/VERSION) file at the root of the
