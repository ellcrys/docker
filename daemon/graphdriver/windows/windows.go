...
package windows // import "github.com/ellcrys/docker/daemon/graphdriver/windows"
...
import (
	...
	"github.com/ellcrys/docker/pkg/longpath"
	...
	if noreexec {
		defer func() {
			if err := winio.DisableProcessPrivileges([]string{winio.SeBackupPrivilege, winio.SeRestorePrivilege}); err != nil {
				...
				// See https://github.com/ellcrys/docker/pull/28002#discussion_r86259241 for rationale.
